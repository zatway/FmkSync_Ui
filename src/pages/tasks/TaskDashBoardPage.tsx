...
export default function TaskDashboardPage() {
    ...
    return (
        <div className="flex min-h-0 min-w-0 flex-1 flex-col max-w-full overflow-x-clip bg-background">
            <div className="container mx-auto flex min-h-0 min-w-0 max-w-full flex-1 flex-col px-3 py-5 sm:px-5 sm:py-7 lg:px-8 lg:py-8">
